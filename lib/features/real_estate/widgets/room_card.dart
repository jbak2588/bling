          ...
          children: [
            if (room.imageUrls.isNotEmpty)
              Image.network(
                ...
                fit: BoxFit.cover,
                errorBuilder: (c, e, s) => Container(height: 200, color: Colors.grey.shade200, child: const Icon(Icons.house_outlined, size: 60, color: Colors.grey)),
              )
            else
              Container(height: 200, color: Colors.grey.shade200, child: const Icon(Icons.house_outlined, size: 60, color: Colors.grey)),
